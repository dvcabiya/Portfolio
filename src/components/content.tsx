    ...
    <>
      ...
      <div className="projectBlock">
        <div className="projectsContainer">
          <div className="projectBox">
            ...
            <span className="projectBody">A website to instantly check the status of Sacramento hip-hop group Death Grips.<a href="https://github.com/vcabiya/death-grips" target="_blank" rel="noopener">(Github)</a></span>
          </div>
          <div className="projectBox">
            ...
            <span className="projectBody">A classic 2D runner game, coded originally in Java, ported to a Python web app.<a href="https://github.com/vcabiya/Runner-Django" target="_blank" rel="noopener">(Github)</a></span>
          </div>
        </div>
      </div>
      ...
      <div className="contactBlock">
        <div className="contactBlock--container">
            <a className="contactLinkText" style={{"marginTop":"-10px"}} href="https://github.com/vcabiya"target="_blank" rel="noopener" >Github</a>
            <a className="contactLinkText contactLinkText--email" href="mailto:dvcabiya@gmail.com"target="_blank" rel="noopener">Email</a>
            <a className="contactLinkText contactLinkText--linkedin"target="_blank" rel="noopener" href="https://www.linkedin.com/in/diegovcabiya/">LinkedIn</a>
        </div>
      </div>
